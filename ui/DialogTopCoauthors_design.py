...
class Ui_DialogTopCoauthors(object):
    def setupUi(self, DialogTopCoauthors):
        ...
        self.tbFilter = QtWidgets.QLineEdit(DialogTopCoauthors)
        self.tbFilter.setText("")
        self.tbFilter.setObjectName("tbFilter")
        self.verticalLayout.addWidget(self.tbFilter)
    ...
    def retranslateUi(self, DialogTopCoauthors):
        ...
        DialogTopCoauthors.setWindowTitle(_translate("DialogTopCoauthors", "Top co-authors"))
        self.lblDesc.setText(_translate("DialogTopCoauthors", "Top co-authors:"))
        self.tbFilter.setPlaceholderText(_translate("DialogTopCoauthors", "Filter"))
